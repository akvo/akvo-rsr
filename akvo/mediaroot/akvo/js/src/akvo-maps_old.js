...
// function addProjectLocations(map, callback) {
//   var resourceURL =  'http://akvo.dev/api/v1/project/?format=jsonp&limit=20&depth=1&callback=?';
...
$(document).ready(function() {
  $('.akvo_map').each(function() {
    ...
    $(mapElement).gmap(options).bind('init', function() {
      ...
      addProjectLocations(mapElement, addMarkers);
