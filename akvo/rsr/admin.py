...
class UserProfileAdminForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        initial_data = {}
        initial_data['is_active']       = kwargs['instance'].get_is_active()
        initial_data['is_org_admin']    = kwargs['instance'].get_is_org_admin()
        initial_data['is_org_editor']   = kwargs['instance'].get_is_org_editor()
