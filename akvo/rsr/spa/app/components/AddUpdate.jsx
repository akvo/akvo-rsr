...
export const AddUpdate = ({
  ...
  const pendingUpdate = (period.updates[0]?.status === 'P' || (indicator.measure === indicatorMeasure.PERCENTAGE && period.updates[0]?.status !== 'R')/* trick % measure update to show as "pending update" */) ? period.updates[0] : null
            ...
            <div className="add-update">
              ...
              <Form aria-orientation="vertical">
                <div className={classNames('inputs-container', { qualitative: indicator.type === 2, 'no-prev': period.updates.filter(it => it.status === 'A').length === 0 })}>
                    ...
                    {indicator.type === 1 ? [
                      <Field
                        ...
                        render={({ input }) => {
                          ...
                          if (categories.length > 0 && indicator.measure === indicatorMeasure.UNIT) {
                          ...
                          if (categories.length > 0 && indicator.measure === indicatorMeasure.PERCENTAGE) {
                      ...
                      indicator.measure === indicatorMeasure.UNIT ?
                        ...
                        <FinalField
                          ...
                          disabled={disableInputs}
                        />,
                      (indicator.measure === indicatorMeasure.UNIT && period.updates.length > 0) && [
                  ...
                  {!mneView && !(indicator.measure === indicatorMeasure.PERCENTAGE && period.updates.length > 0) &&
