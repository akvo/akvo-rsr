...
import { camelReplace, getPercentage, setNumberFormat } from '../utils/misc'
    ...
    <Row>
      {
        cumulativeUpdate?.value
          ? (
            <>
              <Col lg={11}>
                <HintTitle title="Cumulative Updates Hint" value={cumulativeUpdate.value} />
              </Col>
              <Col lg={1}>
                <Divider type="vertical" />
              </Col>
              <Col lg={12}>
                <HintTitle title="Previous Update value" value={lastUpdate.value} />
              </Col>
            </>
          )
          : (
