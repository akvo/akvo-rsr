        ...
        {period && Object.keys(period.projects).filter(projectFilter).map(projectId => {
          ...
          return (
            <li>
              ...
              <div className="right">
                {!unlocked ? [<div className="status locked"><Icon type="lock" /> Locked</div>, <Button size="small" onClick={() => updatePeriods(false, periods, period.dates.join('-'), projectId)}>Unlock</Button>] :
