    ...
    },
    {
      ...
      render: (text, record) => (
        <div>
          ...
          {(record.parent !== null && record.parent.isLead) && (<div className="parent-caption"><span>Lead:</span> <Link to={`/programs/${record.parent.id}`}>{record.parent.title}</Link><br /></div>)/* eslint-disable-line */}
