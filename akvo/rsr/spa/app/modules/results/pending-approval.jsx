              ...
              <ul className="item">
                ...
                <CondWrap wrap={update.indicator.type === 2}>
                  <li>
                    ...
                    <div className="value">
                      {moment(update.lastModifiedAt).fromNow()}
                      <br /><small>by</small><br />
                  ...
                  {update.text &&
                    <li>
                      ...
                      <div className="qualitative-value">
                        <ShowMoreText lines={3}>{update.text}</ShowMoreText>
                      </div>
                    </li>
                  }
                  {
                ...
                <CondWrap wrap>
                  ...
                  <div className="value">
                    <ShowMoreText lines={5}>{update?.comments[0]?.comment}</ShowMoreText>
                  </div>
                </CondWrap>
              </ul>
              <div className="btns">
                <Button type="link" className="primary" loading={loading === 'A'} disabled={isUpdating} onClick={() => handleUpdateStatus(update, 'A')}>{t('Approve')}</Button>
                <DeclinePopup onConfirm={(reviewNote) => handleUpdateStatus(update, 'R', reviewNote)}>
                  <Button type="link" className="danger" loading={loading === 'R'} disabled={isUpdating}>{t('Decline')}</Button>
                </DeclinePopup>
                {(handleOnEdit && !activeKey) && (
                  <Button
                    type="ghost"
                    onClick={() => {
                      handleOnEdit(update)
