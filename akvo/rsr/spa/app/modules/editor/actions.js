...
export const setProjectStatus = (publishingStatus, hasParent) => (dispatch) => {
  dispatch({ type: actionTypes.SAVE_FIELDS, fields: { publishingStatus, hasParent }, sectionIndex: 1, noSync: true })
}
