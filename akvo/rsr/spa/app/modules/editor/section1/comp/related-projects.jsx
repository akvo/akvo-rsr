...
// const ProjectPicker2 = ({ fieldName, projects, loading }) => {
//   // const [options, setOptions] = useState([])
//   const { t } = useTranslation()
//   const filterOptions = value => {
//     if(value.length > 1){
//       const opts = projects.filter(it => it.title.toLowerCase().indexOf(value.toLowerCase()) !== -1)
//       setOptions(opts)
//     }
//   }
//   return (
...
//                 render={({input}) => {
//                   const optFilter = it => it.title.toLowerCase().indexOf(String(input.value).toLowerCase()) !== -1
//                   const filteredProjects = projects && projects.length > 0 && projects.filter(optFilter)
//                   console.log(filteredProjects, projects, input.value)
//                   const $options =
//                     projects && projects.length > 0
//                     ? filteredProjects.map(({id, title}) => ({ value: id, label: title }))
