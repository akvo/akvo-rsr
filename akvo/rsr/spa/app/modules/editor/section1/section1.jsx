    ...
    <div className="info view">
      ...
      <FinalForm
        ...
        render={() => (
          ...
          />
            {!program && <ProjectPicker savedData={null} projects={results && results.filter(it => it.id !== Number(projectId))} hasImportedResults={fields.hasImportedResults} {...{loading, projectId}} />}
