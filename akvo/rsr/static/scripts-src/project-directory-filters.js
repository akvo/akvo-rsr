...
var FilterForm = React.createClass({displayName: "FilterForm",
    ...
    render: function() {
        ...
        var project_count = this.state.disabled ? (
            React.createElement("a", null, this.props.i18n.loading_text)
        ) : (
                ...
                React.createElement("div", {className: "projectCountTxt"}, 
                    React.createElement("nav", {id: "advanced-filter-nav"}, 
                        React.createElement("ul", {className: "nav nav-pills nav-stacked"}, 
                            React.createElement("li", {id: "advanced-filter-status"}, project_count)
                        )
                    )
                )
            )
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    ReactDOM.render(React.createElement(FilterForm, {filters: filters, options_url: url, i18n: i18n}), filtersWrapper);
});
