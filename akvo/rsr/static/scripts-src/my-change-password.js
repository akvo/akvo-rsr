...
$(function() {
    $("#passwordForm").submit(function(event) {
        var close_text = JSON.parse(document.getElementById("password-change-strings").innerHTML)
            .close_text;
        var password_update_text = JSON.parse(
            document.getElementById("password-change-strings").innerHTML
