...
function renderReactComponents() {
    ...
    var IndicatorPeriodValue = React.createClass({
        displayName: "IndicatorPeriodValue",
        render: function() {
    ...
    var IndicatorPeriod = React.createClass({
        ...
        render: function() {
            ...
            return React.createElement("span", null, " (", period_start, " - ", period_end, ")");
        }
    });
    ...
    var ResultList = React.createClass({
        ...
        render: function() {
            ...
            return React.createElement("ul", { className: "list-unstyled" }, results);
        }
    });
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "a",
                            { className: headerCollapse, onClick: this.handleClick },
                            this.header()
                        )
                    )
                ),
                React.createElement(
                    "div",
                    { className: panelCollapse, style: panelStyle },
    ...
    function renderCarousel() {
        ...
        ReactDOM.render(
            React.createElement(CarouselInstance, { source: source }),
