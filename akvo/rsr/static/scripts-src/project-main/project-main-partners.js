...
function renderPartnersTab() {
    var PartnersApp = React.createClass({
        ...
        orgLogo: function(logoUrl, width, height) {
            ...
            if (logoUrl !== "") {
                return React.createElement("img", { src: logoUrl, style: logoStyle });
            } else {
                return React.createElement("img", {
                    src: "/static/images/default-org-logo.jpg",
                    style: logoStyle
                });
            }
        },
        ...
        render: function() {
            if (this.state.partnerships === null) {
                ...
                var organisations = sortedPartnerships.map(function(partner) {
                    ...
                    return React.createElement(
                        "div",
                        { className: "row verticalPadding projectPartners", key: id },
                        React.createElement(
                            "div",
                            { className: "col-sm-2 img" },
                            React.createElement(
                                "a",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "a",
                                { href: "/organisation/" + id + "/", className: "org-link" },
                ...
                return React.createElement("div", null, organisations);
            }
        }
    });
