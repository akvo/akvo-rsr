    ...
    var MorePartnersApp = React.createClass({displayName: 'MorePartnersApp',
        ...
        render: function() {
            if (this.state.partnerships === null) {
                return (
                    React.DOM.a( {href:"#", className:"small moreLink tab-link"}, 
                        React.DOM.i( {className:"fa fa-spin fa-spinner"} ), " ", this.props.i18n.partners
                    )
                );
            } else {
                return (
                    React.DOM.div(null, 
                        React.DOM.a( {href:"#", className:"small moreLink tab-link", onMouseEnter:this.handleMouseEnter, onMouseLeave:this.handleMouseLeave}, 
