...
jsPlumb.ready(function() {
  ...
  instance.doWhileSuspended(function() {
    ...
    var top_sibling_windows = $(
      ".project-hierarchy .project-hierarchy-sibling-top"
    );
    var bottom_sibling_windows = $(
      ".project-hierarchy .project-hierarchy-sibling-bottom"
    );
    ...
    for (i = 0; i < top_sibling_windows.length; i++) {
      var top_sibling_uuid =
        top_sibling_windows[i].getAttribute("id") + "-bottom";
    ...
    for (i = 0; i < bottom_sibling_windows.length; i++) {
      var bottom_sibling_uuid =
        bottom_sibling_windows[i].getAttribute("id") + "-top";
