...
function make_link(message, project_id) {
    ...
    return React.createElement("a", {href: url, target: "_blank"}, cap(message));
}
            ...
            if (this.props.project.checks_errors.length === 0 && this.props.project.checks_warnings.length === 0) {
                ...
                if (errorLength > 0) {
                    ...
                    allErrors = this.props.project.checks_errors.map(function(check) {
                        return (
                            React.createElement("span", null, "- ", cap(i18n.error), ": ", make_link(check, this.props.project.id), React.createElement("br", null))
                        );
                    }, this);
                }
                if (warningLength > 0) {
                    ...
                    allWarnings = this.props.project.checks_warnings.map(function(check) {
                        return (
                            React.createElement("span", null, "- ", cap(i18n.warning), ": ", make_link(check, this.props.project.id), React.createElement("br", null))
                        );
                    }, this);
                }
