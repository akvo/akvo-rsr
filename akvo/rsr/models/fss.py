...
class Fss(models.Model):
    ...
    phaseout_year = models.PositiveIntegerField(_(u'phaseout year'), blank=True, null=True, max_length=4)
...
class FssForecast(models.Model):
    ...
    value = models.DecimalField(_(u'interest received'), max_digits=10, decimal_places=2, blank=True, null=True)
