...
class InternalOrganisationID(models.Model):
    ...
    recording_org = models.ForeignKey('Organisation', verbose_name=u'recording organisation',
                                      related_name='internal_ids')
    referenced_org = models.ForeignKey('Organisation', verbose_name=u'referenced organisation',
