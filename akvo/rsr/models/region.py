...
class RecipientRegion(models.Model):
    ...
    def iati_region(self):
        return dict(codelists.REGION)[self.region] if self.region else None

    def iati_vocabulary(self):
        return dict(codelists.REGION_VOCABULARY)[self.region_vocabulary] if self.region_vocabulary else None
