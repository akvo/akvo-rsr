...
JSON_TEXT = {
    ...
    u"Results": _(u"Results"),
    u"Parent project": _(u"Parent project"),
    u"Project contacts": _(u"Project contacts"),
    u"Project partners": _(u"Project partners"),
    u"Disbursement": _(u"Disbursement"),
    u"Transaction": _(u"Transaction"),
    u"Add another transaction": _(u"Add another transaction"),
    ...
    u"CRS++ and FSS reporting": _("CRS++ and FSS reporting"),
    u"Preview": _(u"Preview"),
    u"menu::settings": _(u"menu::settings"),
    u"External project": _(u"External project"),
    u"Move up": _(u"Move up"),
    u"Move down": _(u"Move down"),
    u"Info": _(u"Info"),
    u"Baseline": _(u"Baseline"),
    u"Link copied!": _(u"Link copied!"),
    u"Get a link to this indicator": _(u"Get a link to this indicator"),
    u"Thematic labels for indicators": _(u"Thematic labels for indicators"),
    u"Get a link to this period": _(u"Get a link to this period"),
    u"Start": _(u"Start"),
    u"End": _(u"End"),
    u"You have insufficient permissions to import results from the selected parent project. Please choose a different parent project.": _(u"You have insufficient permissions to import results from the selected parent project. Please choose a different parent project."),
    u"You have insufficient permissions to copy results from the selected project. Please choose a different project.": _(u"You have insufficient permissions to copy results from the selected project. Please choose a different project."),
    u"Open": _(u"Open"),
    u"Get a link to this result": _(u"Get a link to this result"),
    u"Add new organisation": _(u"Add new organisation"),
    u"Add New Organization": _(u"Add New Organization"),
    u"Long name": _(u"Long name"),
    u"IATI identifier": _(u"IATI identifier"),
    u"Organisation type": _(u"Organisation type"),
    u"Website": _(u"Website"),
    u"Contact name": _(u"Contact name"),
    u"Contact email": _(u"Contact email"),
    u"Organisation logo": _(u"Organisation logo"),
    u"Select Image": _(u"Select Image"),
    u"settings": _(u"settings"),
    u"External child projects": _(u"External child projects"),
    u"Add external child project": _(u"Add external child project"),
    u"Parent project not in RSR": _(u"Parent project not in RSR"),
    u"Include in IATI export": _(u"Include in IATI export"),
    u"(1){child project};(2-inf){child projects};": _(u"(1){child project};(2-inf){child projects};"),
    u"(1){child project};(2-inf){child projects};_plural": _(u"(1){child project};(2-inf){child projects};_plural"),
    u"Go to selected": _(u"Go to selected"),
    u"Level {{level}} projects": _(u"Level {{level}} projects"),
    u"Programs": _(u"Programs"),
    u"Projects hierarchy": _(u"Projects hierarchy"),
    u"Filter": _(u"Filter"),
    u"Select a level {{level}} project with children": _(u"Select a level {{level}} project with children"),
    u"All countries": _(u"All countries"),
    u"All sectors": _(u"All sectors"),
    u"Filter:": _(u"Filter:"),
    u"Privacy": _(u"Privacy"),
    u"public": _(u"public"),
