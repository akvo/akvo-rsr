...
class Location(models.Model):
    ...
    city = models.CharField(_(u'city'), blank=True, max_length=25, help_text=_('(25 characters).'))
    state = models.CharField(_(u'state'), blank=True, max_length=25, help_text=_('(25 characters).'))
    country = models.ForeignKey(Country, verbose_name=_(u'country'))
    address_1 = models.CharField(_(u'address 1'), max_length=25, blank=True, help_text=_('(25 characters).'))
    address_2 = models.CharField(_(u'address 2'), max_length=25, blank=True, help_text=_('(25 characters).'))
