...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectLocation.primary'
        db.delete_column(u'rsr_projectlocation', 'primary')

        # Deleting field 'OrganisationLocation.primary'
        db.delete_column(u'rsr_organisationlocation', 'primary')


    def backwards(self, orm):
        # Adding field 'ProjectLocation.primary'
        db.add_column(u'rsr_projectlocation', 'primary',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)

        # Adding field 'OrganisationLocation.primary'
        db.add_column(u'rsr_organisationlocation', 'primary',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)
