...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rsr_project', 'budget', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'Project.funds'
        db.add_column('rsr_project', 'funds', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'Project.funds_needed'
        db.add_column('rsr_project', 'funds_needed', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)
