...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PublishingStatus', fields ['status']
        db.create_index(u'rsr_publishingstatus', ['status'])


    def backwards(self, orm):
        # Removing index on 'PublishingStatus', fields ['status']
        db.delete_index(u'rsr_publishingstatus', ['status'])
