...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'rsr_minicms')


    def backwards(self, orm):
        # Adding model 'MiniCMS'
        db.create_table(u'rsr_minicms', (
            ('feature_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('feature_box', self.gf('akvo.rsr.fields.ValidXMLTextField')(max_length=350)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('top_right_box', self.gf('akvo.rsr.fields.ValidXMLTextField')(max_length=350)),
            ('lower_height', self.gf('django.db.models.fields.IntegerField')(default=500)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('akvo.rsr.fields.ValidXMLCharField')(max_length=50)),
        ))
