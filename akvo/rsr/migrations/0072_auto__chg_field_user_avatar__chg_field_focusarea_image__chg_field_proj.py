...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'rsr_user', 'avatar', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))

        # Changing field 'FocusArea.image'
        db.alter_column(u'rsr_focusarea', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'Project.current_image'
        db.alter_column(u'rsr_project', 'current_image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'Organisation.logo'
        db.alter_column(u'rsr_organisation', 'logo', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'ProjectUpdate.photo'
        db.alter_column(u'rsr_projectupdate', 'photo', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'User.avatar'
        db.alter_column(u'rsr_user', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'FocusArea.image'
        db.alter_column(u'rsr_focusarea', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Project.current_image'
        db.alter_column(u'rsr_project', 'current_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Organisation.logo'
        db.alter_column(u'rsr_organisation', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'ProjectUpdate.photo'
        db.alter_column(u'rsr_projectupdate', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
