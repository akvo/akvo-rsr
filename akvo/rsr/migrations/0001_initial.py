    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', akvo.rsr.fields.ValidXMLTextField(default='', verbose_name='Notes and comments', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(related_query_name='employment', related_name='employments', on_delete=django.db.models.deletion.SET_NULL, verbose_name='group', to='auth.Group', help_text="The permissions group for this user's employment.", null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ascending', models.BooleanField(null=True, help_text='Is the aim of the project to increase or decrease the value of the indicator?', verbose_name='ascending')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('engine', akvo.rsr.fields.ValidXMLCharField(default='paypal', max_length=10, verbose_name='payment engine', choices=[('paypal', 'PayPal'), ('ideal', 'iDEAL')])),
                ...
                ('status', models.PositiveSmallIntegerField(default=1, verbose_name='status', choices=[(1, 'Pending'), (2, 'Void'), (3, 'Complete'), (4, 'Stale')])),
                ...
                ('bank', akvo.rsr.fields.ValidXMLCharField(blank=True, max_length=4, verbose_name='mollie.nl bank ID', choices=[('', 'Please select your bank'), ('0031', 'ABN AMRO'), ('0761', 'ASN Bank'), ('0081', 'Fortis'), ('0091', 'Friesland Bank'), ('0721', 'ING/Postbank'), ('0021', 'Rabobank'), ('0751', 'SNS Bank'), ('0771', 'SNS Regio Bank'), ('0511', 'Triodos Bank')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('kind', akvo.rsr.fields.ValidXMLCharField(max_length=1, verbose_name='kind', choices=[('A', 'Akvopedia entry'), ('E', 'External link')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', akvo.rsr.fields.ValidXMLCharField(default='EUR', max_length=3, choices=[('USD', '$'), ('EUR', '\xe2\x82\xac')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', akvo.rsr.fields.ValidXMLCharField(default='en', help_text='The main language of the organisation', max_length=2, choices=[('de', 'German'), ('en', 'English'), ('nl', 'Dutch'), ('es', 'Spanish'), ('fr', 'French'), ('ru', 'Russian')])),
                ('organisation_type', akvo.rsr.fields.ValidXMLCharField(db_index=True, max_length=1, verbose_name='organisation type', choices=[('N', 'NGO'), ('G', 'Governmental'), ('C', 'Commercial'), ('K', 'Knowledge institution')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_level', akvo.rsr.fields.ValidXMLCharField(default='archived', max_length=12, verbose_name='account level', choices=[('archived', 'Free'), ('freemium', 'Freemium'), ('premium', 'Premium'), ('plus', 'Premium Plus'), ('archived', 'Archived')])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(db_index=True, auto_now_add=True, null=True)),
                ('last_modified_at', models.DateTimeField(db_index=True, auto_now=True, null=True)),
                ('notes', akvo.rsr.fields.ValidXMLTextField(default='', verbose_name='Akvo partner site notes', blank=True)),
                ...
                ('custom_return_url_text', akvo.rsr.fields.ValidXMLCharField(default='', help_text='<p>Enter a text for the back button and return URL. Leave empty to display "Back to <em>myorganisation</em>".</p>', max_length=50, verbose_name='Return URL text', blank=True)),
                ...
                ('default_language', akvo.rsr.fields.ValidXMLCharField(default='en', max_length=5, verbose_name='Site UI default language', choices=[('de', 'German'), ('en', 'English'), ('nl', 'Dutch'), ('es', 'Spanish'), ('fr', 'French'), ('ru', 'Russian')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locale', akvo.rsr.fields.ValidXMLCharField(default='US', max_length=2, choices=[('US', 'US English')])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', akvo.rsr.fields.ValidXMLCharField(default='en', help_text='The main language of the project.', max_length=2, choices=[('de', 'German'), ('en', 'English'), ('nl', 'Dutch'), ('es', 'Spanish'), ('fr', 'French'), ('ru', 'Russian')])),
                ('project_rating', models.IntegerField(default=0, verbose_name='project rating')),
                ('notes', akvo.rsr.fields.ValidXMLTextField(default='', help_text='(Unlimited number of characters).', verbose_name='notes', blank=True)),
                ('currency', akvo.rsr.fields.ValidXMLCharField(default='EUR', help_text='The default currency for this project. Used in all financial aspects of the project.', max_length=3, verbose_name='currency', choices=[('USD', '$'), ('EUR', '\xe2\x82\xac')])),
                ...
                ('sync_owner_secondary_reporter', models.BooleanField(null=True, help_text='This indicates whether the reporting organisation is a secondary publisher: publishing data for which it is not directly responsible.', verbose_name='secondary reporter')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attached', models.BooleanField(null=True, verbose_name='attached')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', akvo.rsr.fields.ValidXMLCharField(default='en', help_text='The language of the update', max_length=2, choices=[('de', 'German'), ('en', 'English'), ('nl', 'Dutch'), ('es', 'Spanish'), ('fr', 'French'), ('ru', 'Russian')])),
                ...
                ('update_method', akvo.rsr.fields.ValidXMLCharField(default='W', choices=[('W', 'web'), ('E', 'e-mail'), ('S', 'SMS'), ('M', 'mobile')], max_length=1, blank=True, verbose_name='update method', db_index=True)),
                ('user_agent', akvo.rsr.fields.ValidXMLCharField(default='', max_length=200, verbose_name='user agent', blank=True)),
                ('uuid', akvo.rsr.fields.ValidXMLCharField(default='', max_length=40, blank=True, help_text='Universally unique ID set by creating user agent', verbose_name='uuid', db_index=True)),
                ('notes', akvo.rsr.fields.ValidXMLTextField(default='', verbose_name='Notes and comments', blank=True)),
            ],
            options={
                'ordering': ['-id'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('status', akvo.rsr.fields.ValidXMLCharField(default='unpublished', max_length=30, db_index=True, choices=[('unpublished', 'Unpublished'), ('published', 'Published')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aggregation_status', models.BooleanField(null=True, verbose_name='aggregation status')),
