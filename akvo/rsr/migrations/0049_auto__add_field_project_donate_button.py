...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.donate_button'
        db.add_column('rsr_project', 'donate_button',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.donate_button'
        db.delete_column('rsr_project', 'donate_button')
