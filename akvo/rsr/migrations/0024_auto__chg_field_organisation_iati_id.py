...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organisation.iati_id'
        db.alter_column('rsr_organisation', 'iati_id', self.gf('django.db.models.fields.CharField')(default='', max_length=75))

    def backwards(self, orm):

        # Changing field 'Organisation.iati_id'
        db.alter_column('rsr_organisation', 'iati_id', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))
    ...
    models = {
        ...
        'rsr.organisation': {
            ...
            'iati_id': ('django.db.models.fields.CharField', [], {'max_length': '75', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
