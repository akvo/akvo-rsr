...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for obj in orm.Project.objects.all():
            if obj.publishingstatus:
                obj.publishing_status = obj.publishingstatus.status
            else:
                obj.publishing_status = obj.PUBLISHING_STATUS_UNPUBLISHED
            obj.save()
