...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.date_start_planned'
        db.alter_column(u'rsr_project', 'date_start_planned', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'ProjectContact.telephone'
        db.alter_column(u'rsr_projectcontact', 'telephone', self.gf('akvo.rsr.fields.ValidXMLCharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'Project.date_start_planned'
        db.alter_column(u'rsr_project', 'date_start_planned', self.gf('django.db.models.fields.DateField')())

        # Changing field 'ProjectContact.telephone'
        db.alter_column(u'rsr_projectcontact', 'telephone', self.gf('akvo.rsr.fields.ValidXMLCharField')(max_length=15))
