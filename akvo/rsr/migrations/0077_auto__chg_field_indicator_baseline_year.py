...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Indicator.baseline_year'
        db.alter_column(u'rsr_indicator', 'baseline_year', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=4, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Indicator.baseline_year'
        raise RuntimeError("Cannot reverse this migration. 'Indicator.baseline_year' and its values cannot be restored.")
