...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlannedDisbursement.type'
        db.add_column(u'rsr_planneddisbursement', 'type',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Project.sync_owner_secondary_reporter'
        db.add_column(u'rsr_project', 'sync_owner_secondary_reporter',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProjectContact.department'
        db.add_column(u'rsr_projectcontact', 'department',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlannedDisbursement.type'
        db.delete_column(u'rsr_planneddisbursement', 'type')

        # Deleting field 'Project.sync_owner_secondary_reporter'
        db.delete_column(u'rsr_project', 'sync_owner_secondary_reporter')

        # Deleting field 'ProjectContact.department'
        db.delete_column(u'rsr_projectcontact', 'department')
