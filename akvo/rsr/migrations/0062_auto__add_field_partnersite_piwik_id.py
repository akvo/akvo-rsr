...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerSite.piwik_id'
        db.add_column(u'rsr_partnersite', 'piwik_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerSite.piwik_id'
        db.delete_column(u'rsr_partnersite', 'piwik_id')
