...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for user in orm['auth.User'].objects.all():
            new_user = orm['rsr.customuser'].create_user(user.email, user.password)
            new_user.id = user.id
    ...
    def backwards(self, orm):
        ...
        for user in orm['rsr.customuser'].objects.all():
            new_user = orm['auth.User'].create_user(user.email, user.password)
            new_user.id = user.id
            new_user.username = user.username
            new_user.save()
