...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.publishing_status'
        db.add_column('rsr_project', 'publishing_status',
                      self.gf('django.db.models.fields.CharField')(default='unpublished', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.publishing_status'
        db.delete_column('rsr_project', 'publishing_status')
    ...
    models = {
        ...
        'rsr.project': {
            ...
            'publishing_status': ('django.db.models.fields.CharField', [], {'default': "'unpublished'", 'max_length': '30'}),
