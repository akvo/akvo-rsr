...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'rsr_user', 'is_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Employment.group'
        db.add_column(u'rsr_employment', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='employments', null=True, on_delete=models.SET_NULL, to=orm['auth.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.is_admin'
        db.delete_column(u'rsr_user', 'is_admin')

        # Deleting field 'Employment.group'
        db.delete_column(u'rsr_employment', 'group_id')
