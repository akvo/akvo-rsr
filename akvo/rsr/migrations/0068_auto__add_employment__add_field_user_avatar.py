...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employment.is_approved'
        db.add_column(u'rsr_employment', 'is_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Employment.country'
        db.add_column(u'rsr_employment', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rsr.Country'], null=True),
                      keep_default=False)
        ...
        db.add_column(u'rsr_user', 'avatar',
