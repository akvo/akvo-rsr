...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.confirmation_email_sent'
        db.add_column('rsr_invoice', 'confirmation_email_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.confirmation_email_sent'
        db.delete_column('rsr_invoice', 'confirmation_email_sent')
