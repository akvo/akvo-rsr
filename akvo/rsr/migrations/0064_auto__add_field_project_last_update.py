...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'rsr_project', 'last_update',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='the_project', null=True, on_delete=models.SET_NULL, to=orm['rsr.ProjectUpdate']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.last_update'
        db.delete_column(u'rsr_project', 'last_update_id')
