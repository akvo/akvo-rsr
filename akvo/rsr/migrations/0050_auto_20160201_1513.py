    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', akvo.rsr.fields.ValidXMLCharField(default='D', choices=[('D', 'draft'), ('P', 'pending approval'), ('R', 'return for revision'), ('A', 'approved')], max_length=1, blank=True, verbose_name='status', db_index=True)),
                ...
                ('update_method', akvo.rsr.fields.ValidXMLCharField(default='W', choices=[('W', 'web'), ('M', 'mobile')], max_length=1, blank=True, verbose_name='update method', db_index=True)),
