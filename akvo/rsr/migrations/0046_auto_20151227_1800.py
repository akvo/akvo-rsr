...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='iatiimport',
            name='frequency',
            field=models.PositiveIntegerField(default=1, choices=[(1, 'hourly'), (2, 'every six hours'), (3, 'daily'), (4, 'every three days'), (5, 'weekly'), (6, 'bi-weekly'), (7, 'every four weeks')]),
        ...
        migrations.AddField(
            model_name='iatiimport',
            name='mapper_prefix',
            field=models.CharField(help_text=b'Prefix used to identify child classes overriding default import behaviour', max_length=30, verbose_name='mapper prefix', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='iatiimport',
        ...
        migrations.AddField(
            model_name='iatiimportlog',
            name='iati_import_job',
            field=models.ForeignKey(related_name='iati_import_logs', default=1, verbose_name='iati import', to='rsr.IatiImportJob'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='iatiimportlog',
