...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectUpdateLocation'
        db.create_table(u'rsr_projectupdatelocation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('latitude', self.gf('akvo.rsr.fields.LatitudeField')(default=0, db_index=True)),
            ('longitude', self.gf('akvo.rsr.fields.LongitudeField')(default=0, db_index=True)),
            ('city', self.gf('akvo.rsr.fields.ValidXMLCharField')(max_length=255, blank=True)),
            ('state', self.gf('akvo.rsr.fields.ValidXMLCharField')(max_length=255, blank=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rsr.Country'])),
            ('address_1', self.gf('akvo.rsr.fields.ValidXMLCharField')(max_length=255, blank=True)),
            ('address_2', self.gf('akvo.rsr.fields.ValidXMLCharField')(max_length=255, blank=True)),
            ('postcode', self.gf('akvo.rsr.fields.ValidXMLCharField')(max_length=10, blank=True)),
            ('location_target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='locations', null=True, to=orm['rsr.ProjectUpdate'])),
        ))
        db.send_create_signal(u'rsr', ['ProjectUpdateLocation'])

        # Adding field 'ProjectUpdate.primary_location'
        db.add_column(u'rsr_projectupdate', 'primary_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rsr.ProjectUpdateLocation'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProjectUpdateLocation'
        db.delete_table(u'rsr_projectupdatelocation')

        # Deleting field 'ProjectUpdate.primary_location'
        db.delete_column(u'rsr_projectupdate', 'primary_location_id')
