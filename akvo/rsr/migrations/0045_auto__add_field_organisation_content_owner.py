...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.content_owner'
        db.add_column('rsr_organisation', 'content_owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rsr.Organisation'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.content_owner'
        db.delete_column('rsr_organisation', 'content_owner_id')
    ...
    models = {
        ...
        'rsr.organisation': {
            ...
            'content_owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rsr.Organisation']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
