...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rsr_location', 'address_2', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Location.address_1'
        db.alter_column('rsr_location', 'address_1', self.gf('django.db.models.fields.CharField')(max_length=25))
    def backwards(self, orm):

        # Changing field 'Location.address_2'
        db.alter_column('rsr_location', 'address_2', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Location.address_1'
        db.alter_column('rsr_location', 'address_1', self.gf('django.db.models.fields.CharField')(max_length=255))
    models = {
        'auth.group': {
