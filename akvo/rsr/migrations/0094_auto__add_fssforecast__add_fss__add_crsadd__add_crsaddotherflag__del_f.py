...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FssForecast'
        db.create_table(u'rsr_fssforecast', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fss', self.gf('django.db.models.fields.related.ForeignKey')(related_name='forecasts', to=orm['rsr.Fss'])),
        ...
        db.send_create_signal('rsr', ['FssForecast'])

        # Adding model 'Fss'
        db.create_table(u'rsr_fss', (
            ('project', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rsr.Project'], unique=True, primary_key=True)),
            ('extraction_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('priority', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('phaseout_year', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=4, null=True, blank=True)),
        ))
        db.send_create_signal('rsr', ['Fss'])

        # Adding model 'CrsAdd'
        db.create_table(u'rsr_crsadd', (
            ('project', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rsr.Project'], unique=True, primary_key=True)),
            ('loan_terms_rate1', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True)),
            ('loan_terms_rate2', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True)),
            ('repayment_type', self.gf('akvo.rsr.fields.ValidXMLCharField')(max_length=1)),
            ('repayment_plan', self.gf('akvo.rsr.fields.ValidXMLCharField')(max_length=2)),
            ('commitment_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('repayment_first_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('repayment_final_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('loan_status_year', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=4, null=True, blank=True)),
            ('loan_status_currency', self.gf('akvo.rsr.fields.ValidXMLCharField')(max_length=3, blank=True)),
            ('loan_status_value_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('interest_received', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
            ('principal_outstanding', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
            ('principal_arrears', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
            ('interest_arrears', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
        ))
        db.send_create_signal('rsr', ['CrsAdd'])

        # Adding model 'CrsAddOtherFlag'
        db.create_table(u'rsr_crsaddotherflag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('crs', self.gf('django.db.models.fields.related.ForeignKey')(related_name='other_flags', to=orm['rsr.CrsAdd'])),
            ('code', self.gf('akvo.rsr.fields.ValidXMLCharField')(max_length=1)),
            ('significance', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal('rsr', ['CrsAddOtherFlag'])

        # Deleting field 'Result.description_type'
        db.delete_column(u'rsr_result', 'description_type')

        # Deleting field 'Indicator.description_type'
        db.delete_column(u'rsr_indicator', 'description_type')

        # Adding field 'RelatedProject.related_iati_id'
        db.add_column(u'rsr_relatedproject', 'related_iati_id',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=100, blank=True),
                      keep_default=False)


        # Changing field 'RelatedProject.related_project'
        db.alter_column(u'rsr_relatedproject', 'related_project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rsr.Project']))
        # Adding field 'Project.conditions_attached'
        db.add_column(u'rsr_project', 'conditions_attached',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.country_budget_vocabulary'
        db.add_column(u'rsr_project', 'country_budget_vocabulary',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Deleting field 'CountryBudgetItem.vocabulary'
        db.delete_column(u'rsr_countrybudgetitem', 'vocabulary')

        # Deleting field 'Transaction.finance_type_text'
        db.delete_column(u'rsr_transaction', 'finance_type_text')

        # Deleting field 'Transaction.aid_type_text'
        db.delete_column(u'rsr_transaction', 'aid_type_text')

        # Deleting field 'Transaction.transaction_type_text'
        db.delete_column(u'rsr_transaction', 'transaction_type_text')

        # Deleting field 'Transaction.flow_type_text'
        db.delete_column(u'rsr_transaction', 'flow_type_text')

        # Deleting field 'Transaction.disbursement_channel_text'
        db.delete_column(u'rsr_transaction', 'disbursement_channel_text')

        # Deleting field 'Transaction.tied_status_text'
        db.delete_column(u'rsr_transaction', 'tied_status_text')

        # Adding field 'Transaction.recipient_country'
        db.add_column(u'rsr_transaction', 'recipient_country',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.recipient_region'
        db.add_column(u'rsr_transaction', 'recipient_region',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=3, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.recipient_region_vocabulary'
        db.add_column(u'rsr_transaction', 'recipient_region_vocabulary',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.sector'
        db.add_column(u'rsr_transaction', 'sector',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=5, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.sector_category'
        db.add_column(u'rsr_transaction', 'sector_category',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=3, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.sector_other'
        db.add_column(u'rsr_transaction', 'sector_other',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Deleting field 'ProjectCondition.attached'
        db.delete_column(u'rsr_projectcondition', 'attached')


    def backwards(self, orm):
        # Deleting model 'FssForecast'
        db.delete_table(u'rsr_fssforecast')

        # Deleting model 'Fss'
        db.delete_table(u'rsr_fss')

        # Deleting model 'CrsAdd'
        db.delete_table(u'rsr_crsadd')

        # Deleting model 'CrsAddOtherFlag'
        db.delete_table(u'rsr_crsaddotherflag')

        # Adding field 'Result.description_type'
        db.add_column(u'rsr_result', 'description_type',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Indicator.description_type'
        db.add_column(u'rsr_indicator', 'description_type',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Deleting field 'RelatedProject.related_iati_id'
        db.delete_column(u'rsr_relatedproject', 'related_iati_id')


        # Changing field 'RelatedProject.related_project'
        db.alter_column(u'rsr_relatedproject', 'related_project_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['rsr.Project']))
        # Deleting field 'Project.conditions_attached'
        db.delete_column(u'rsr_project', 'conditions_attached')

        # Deleting field 'Project.country_budget_vocabulary'
        db.delete_column(u'rsr_project', 'country_budget_vocabulary')

        # Adding field 'CountryBudgetItem.vocabulary'
        db.add_column(u'rsr_countrybudgetitem', 'vocabulary',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.finance_type_text'
        db.add_column(u'rsr_transaction', 'finance_type_text',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.aid_type_text'
        db.add_column(u'rsr_transaction', 'aid_type_text',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.transaction_type_text'
        db.add_column(u'rsr_transaction', 'transaction_type_text',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.flow_type_text'
        db.add_column(u'rsr_transaction', 'flow_type_text',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.disbursement_channel_text'
        db.add_column(u'rsr_transaction', 'disbursement_channel_text',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.tied_status_text'
        db.add_column(u'rsr_transaction', 'tied_status_text',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'Transaction.recipient_country'
        db.delete_column(u'rsr_transaction', 'recipient_country')

        # Deleting field 'Transaction.recipient_region'
        db.delete_column(u'rsr_transaction', 'recipient_region')

        # Deleting field 'Transaction.recipient_region_vocabulary'
        db.delete_column(u'rsr_transaction', 'recipient_region_vocabulary')

        # Deleting field 'Transaction.sector'
        db.delete_column(u'rsr_transaction', 'sector')

        # Deleting field 'Transaction.sector_category'
        db.delete_column(u'rsr_transaction', 'sector_category')

        # Deleting field 'Transaction.sector_other'
        db.delete_column(u'rsr_transaction', 'sector_other')

        # Adding field 'ProjectCondition.attached'
        db.add_column(u'rsr_projectcondition', 'attached',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'rsr.crsadd': {
            'Meta': {'object_name': 'CrsAdd'},
            'commitment_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'interest_arrears': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'interest_received': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'loan_status_currency': ('akvo.rsr.fields.ValidXMLCharField', [], {'max_length': '3', 'blank': 'True'}),
            'loan_status_value_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'loan_status_year': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'loan_terms_rate1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2', 'blank': 'True'}),
            'loan_terms_rate2': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2', 'blank': 'True'}),
            'principal_arrears': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'principal_outstanding': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['rsr.Project']", 'unique': 'True', 'primary_key': 'True'}),
            'repayment_final_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'repayment_first_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'repayment_plan': ('akvo.rsr.fields.ValidXMLCharField', [], {'max_length': '2'}),
            'repayment_type': ('akvo.rsr.fields.ValidXMLCharField', [], {'max_length': '1'})
        },
        'rsr.crsaddotherflag': {
            'Meta': {'object_name': 'CrsAddOtherFlag'},
            'code': ('akvo.rsr.fields.ValidXMLCharField', [], {'max_length': '1'}),
            'crs': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'other_flags'", 'to': "orm['rsr.CrsAdd']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'significance': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'})
        },
        'rsr.employment': {
        ...
        'rsr.fss': {
            'Meta': {'object_name': 'Fss'},
            'extraction_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'phaseout_year': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'priority': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['rsr.Project']", 'unique': 'True', 'primary_key': 'True'})
        },
        'rsr.fssforecast': {
            'Meta': {'object_name': 'FssForecast'},
            'currency': ('akvo.rsr.fields.ValidXMLCharField', [], {'max_length': '3', 'blank': 'True'}),
            'fss': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'forecasts'", 'to': "orm['rsr.Fss']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'rsr.project': {
            ...
            'conditions_attached': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'country_budget_vocabulary': ('akvo.rsr.fields.ValidXMLCharField', [], {'max_length': '1', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'currency': ('akvo.rsr.fields.ValidXMLCharField', [], {'default': "'EUR'", 'max_length': '3'}),
        ...
        'rsr.relatedproject': {
            ...
            'related_iati_id': ('akvo.rsr.fields.ValidXMLCharField', [], {'max_length': '100', 'blank': 'True'}),
            'related_project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'related_to_projects'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['rsr.Project']"}),
        ...
        'rsr.transaction': {
            ...
            'recipient_country': ('akvo.rsr.fields.ValidXMLCharField', [], {'max_length': '2', 'blank': 'True'}),
            'recipient_region': ('akvo.rsr.fields.ValidXMLCharField', [], {'max_length': '3', 'blank': 'True'}),
            'recipient_region_vocabulary': ('akvo.rsr.fields.ValidXMLCharField', [], {'max_length': '1', 'blank': 'True'}),
            'reference': ('akvo.rsr.fields.ValidXMLCharField', [], {'max_length': '25', 'blank': 'True'}),
            'sector': ('akvo.rsr.fields.ValidXMLCharField', [], {'max_length': '5', 'blank': 'True'}),
            'sector_category': ('akvo.rsr.fields.ValidXMLCharField', [], {'max_length': '3', 'blank': 'True'}),
            'sector_other': ('akvo.rsr.fields.ValidXMLCharField', [], {'max_length': '50', 'blank': 'True'}),
