...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectUpdate.user_agent'
        db.add_column('rsr_projectupdate', 'user_agent',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectUpdate.user_agent'
        db.delete_column('rsr_projectupdate', 'user_agent')
