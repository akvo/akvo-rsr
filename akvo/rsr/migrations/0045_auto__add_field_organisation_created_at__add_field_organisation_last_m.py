...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.created_at'
        db.add_column('rsr_organisation', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Organisation.last_modified_at'
        db.add_column('rsr_organisation', 'last_modified_at',
        ...
        db.add_column('rsr_project', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.last_modified_at'
        db.add_column('rsr_project', 'last_modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, db_index=True, blank=True),
                      keep_default=False)

        # Renaming field 'ProjectUpdate.time'
        db.rename_column('rsr_projectupdate', 'time', 'created_at',)

        # Renaming field 'ProjectUpdate.time_last_updated'
        db.rename_column('rsr_projectupdate', 'time_last_updated', 'last_modified_at',)

        # Adding field 'PartnerSite.created_at'
        db.add_column('rsr_partnersite', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'PartnerSite.last_modified_at'
        db.add_column('rsr_partnersite', 'last_modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.created_at'
        db.delete_column('rsr_organisation', 'created_at')

        # Deleting field 'Organisation.last_modified_at'
        db.delete_column('rsr_organisation', 'last_modified_at')

        # Deleting field 'Project.created_at'
        db.delete_column('rsr_project', 'created_at')

        # Deleting field 'Project.last_modified_at'
        db.delete_column('rsr_project', 'last_modified_at')

        # Renaming field 'ProjectUpdate.created_at'
        db.rename_column('rsr_projectupdate', 'created_at', 'time',)

        # Renaming field 'ProjectUpdate.last_modified_at'
        db.rename_column('rsr_projectupdate', 'last_modified_at', 'time_last_updated',)

        # Deleting field 'PartnerSite.created_at'
        db.delete_column('rsr_partnersite', 'created_at')

        # Deleting field 'PartnerSite.last_modified_at'
        db.delete_column('rsr_partnersite', 'last_modified_at')
