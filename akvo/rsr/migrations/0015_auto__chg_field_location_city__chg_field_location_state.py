...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rsr_location', 'city', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Location.state'
        db.alter_column('rsr_location', 'state', self.gf('django.db.models.fields.CharField')(max_length=25))
    def backwards(self, orm):

        # Changing field 'Location.city'
        db.alter_column('rsr_location', 'city', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Location.state'
        db.alter_column('rsr_location', 'state', self.gf('django.db.models.fields.CharField')(max_length=255))
    models = {
        'auth.group': {
        ...
        'rsr.location': {
            ...
            'address_1': ('django.db.models.fields.CharField', [], {'max_length': '25', 'blank': 'True'}),
            'address_2': ('django.db.models.fields.CharField', [], {'max_length': '25', 'blank': 'True'}),
            'city': ('django.db.models.fields.CharField', [], {'max_length': '25', 'blank': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
