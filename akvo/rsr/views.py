        ...
        if donate_form.is_valid():
            ...
            if settings.PAYPAL_DEBUG:
                pp_dict = {
                    ...
                    'item_name': 'TEST %s: Project %s - %s' % (settings.PAYPAL_PRODUCT_DESCRIPTION_PREFIX,
                                                              str(invoice.project.id),
                ...
                pp_dict = {
                    ...
                    'amount': invoice.amount,
                    'item_name': '%s: Project %s - %s' % (settings.PAYPAL_PRODUCT_DESCRIPTION_PREFIX,
                                                         str(invoice.project.id),
                                                         invoice.project.name),
                    'invoice': invoice.id,
                    'lc': invoice.locale,
