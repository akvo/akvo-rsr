...
class PartnerSiteModelTestCase(TestCase):
    ...
    def test_pages_projects(self):
        ...
        # When
        page_1 = PartnerSite.objects.create(organisation=self.org_1, hostname="page1", piwik_id=0)
        page_2 = PartnerSite.objects.create(organisation=self.org_2, hostname="page2", piwik_id=0)
