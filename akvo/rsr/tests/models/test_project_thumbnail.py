...
from akvo.rsr.models.project_thumbnail import get_cached_thumbnail, validate_geometry_string
...
class ProjectThumbnailModelTestCase(BaseTestCase):
    ...
    def test_invalid_geometry_string(self):
        with self.assertRaisesRegex(ValidationError, "Geometry must have the format"):
            validate_geometry_string("abcdec")

    def test_valid_geometry_string(self):
        validate_geometry_string("200x200")
