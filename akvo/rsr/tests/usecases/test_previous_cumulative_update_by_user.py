...
class BaseCumulativeTestCase(BaseTestCase):
    ...
    def add_update(self, period_start, user=None, value=None, numerator=None, denominator=None, disaggregations=None):
    ...
    def get_previous_cumulative_update_value(self):
        return get_previous_cumulative_update_value(self.user, self.indicator)
...
class NonCumulativeIndicatorTestCase(BaseCumulativeTestCase):
    ...
    def test_no_cumulative_update(self):
        self.add_update(PERIOD_START_1, value=10, disaggregations={
            DISAGGREGATION_TYPE_1: {'value': 3},
            DISAGGREGATION_TYPE_2: {'value': 7},
        })
        result = self.get_previous_cumulative_update_value()
...
class CumulativeUnitIndicatorUserUpdateTestCase(BaseCumulativeTestCase):
    ...
    def test_multiple_updates_one_period(self):
        ...
        self.add_update(PERIOD_START_1, value=15, disaggregations={
    ...
    def test_multiple_period(self):
        ...
        self.add_update(PERIOD_START_2, value=15, disaggregations={
            DISAGGREGATION_TYPE_1: {'value': 5},
            DISAGGREGATION_TYPE_2: {'value': 10},
        })
        self.add_update(PERIOD_START_1, value=10, disaggregations={
    ...
    def test_multiple_user(self):
        ...
        self.add_update(PERIOD_START_1, user=other_user, value=15, disaggregations={
            DISAGGREGATION_TYPE_1: {'value': 5},
            DISAGGREGATION_TYPE_2: {'value': 10},
        })
        result = self.get_previous_cumulative_update_value()
...
class CumulativePercentageIndicatorUpdateTestCase(BaseCumulativeTestCase):
    ...
    def test_multiple_period(self):
        self.add_update(PERIOD_START_1, numerator=10, denominator=10, disaggregations={
            DISAGGREGATION_TYPE_1: {'numerator': 3, 'denominator': 10},
            DISAGGREGATION_TYPE_2: {'numerator': 7, 'denominator': 10},
        })
        self.add_update(PERIOD_START_2, numerator=15, denominator=20, disaggregations={
