...
export const API_LIMIT = 100,
    ...
    UPDATE_BUTTONS = {
        [ROLE_ME_MANAGER]: {
            ...
            [UPDATE_STATUS_DRAFT]: [
                ...
                UPDATE_ACTION_SAVE,
                UPDATE_ACTION_APPROVE
            ],
            [UPDATE_STATUS_PENDING]: [
                UPDATE_ACTION_SAVE,
                UPDATE_ACTION_RETURN,
                UPDATE_ACTION_APPROVE
            ],
        ...
        [ROLE_PROJECT_EDITOR]: {
            ...
            [UPDATE_STATUS_DRAFT]: [UPDATE_ACTION_DELETE, UPDATE_ACTION_SAVE, UPDATE_ACTION_SUBMIT],
            [UPDATE_STATUS_PENDING]: [],
            [UPDATE_STATUS_REVISION]: [
                UPDATE_ACTION_DELETE,
                UPDATE_ACTION_SAVE,
                UPDATE_ACTION_SUBMIT
            ],
    ...
    ALL_MODELS_LIST = [
        OBJECTS_DIMENSION_NAMES,
        OBJECTS_DIMENSION_VALUES,
    ...
    UPDATE_MODEL_FIELD = "UPDATE_MODEL_FIELD",
