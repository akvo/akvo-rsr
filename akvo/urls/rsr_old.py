...
urlpatterns = patterns(
    ...
    # New activate view
    url(r'^activate/(?P<activation_key>\w+)/$', 'akvo.rsr.vanilla_views.activate', name='activate'),

    # New login view
    url(r'^login/$', 'akvo.rsr.vanilla_views.sign_in', name='sign_in'),

    # New logout view
    url(r'^logout/$', 'akvo.rsr.vanilla_views.sign_out', name='sign_out'),
