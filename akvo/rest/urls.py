...
router.register(r'(?P<version>(v1))/indicator_period_actual_dimension', views.IndicatorPeriodActualDimensionViewSet)
...
router.register(r'(?P<version>(v1))/indicator_period_target_dimension', views.IndicatorPeriodTargetDimensionViewSet)
...
router.register(r'(?P<version>(v1|v2))/report', views.ReportViewSet, base_name='reports_api')
