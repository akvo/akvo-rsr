...
root_url = re_path(r'(?P<version>(v1|v2))/$', router.get_api_root_view(), name=router.root_view_name)
...
urlpatterns = (
    ...
    path('v1/employment/<int:pk>/set_group/<int:group_id>/',
        views.set_group,
        name='set_group'),
    path('v1/user/<int:pk>/change_password/',
        views.change_password,
        name='user_change_password'),
    path('v1/organisations/<int:pk>/users/',
        views.organisation_user_roles,
        name='organisation_user_roles'),
    path('v1/managed-employments/',
        views.managed_employments,
        name='managed_employments'),
    path('v1/organisations/<int:org_pk>/users/<int:user_pk>/',
        views.change_user_roles,
        name='change_organisation_user_roles'),
    path('v1/user/<int:pk>/update_details/',
    ...
    path('v1/invite_user/',
        views.invite_user,
        name='invite_user'),
    path('v1/project_iati_check/<int:pk>/',
        views.ProjectIatiCheckView.as_view(),
        name='project_iati_check'),
    path('v1/project_update/<int:update_pk>/photos/',
        views.project_update_photos,
        name='project_update_add_photos'),
    path('v1/project_update/<int:update_pk>/photos/<int:photo_pk>/',
        views.project_update_photos,
        name='project_update_remove_photos'),
    path('v1/indicator_period_data/<int:pk>/upload_file/',
        views.indicator_upload_file,
        name='indicator_upload_file'),
    path('v1/indicator_period_data/<int:update_pk>/files/',
        views.period_update_files,
        name='period_update_add_files'),
    path('v1/indicator_period_data/<int:update_pk>/files/<int:file_pk>/',
        views.period_update_files,
        name='period_update_remove_files'),
    path('v1/indicator_period_data/<int:update_pk>/photos/',
        views.period_update_photos,
        name='period_update_add_photos'),
    path('v1/indicator_period_data/<int:update_pk>/photos/<int:photo_pk>/',
        views.period_update_photos,
        name='period_update_remove_photos'),
    path('v1/set-periods-locked/<int:project_pk>/',
        views.set_periods_locked,
        name='set_periods_locked'),
    path('v1/set-updates-status/<int:project_pk>/',
        views.set_updates_status,
        name='set_updates_status'),
    path('v1/right_now_in_akvo/', views.right_now_in_akvo_view, name='right_now_in_akvo'),
    path('v1/server_info/', views.server_info, name='server_info'),
    path('v1/title-and-status/<int:project_pk>/', views.project_title, name='project_title'),
    path('v1/project/<int:project_pk>/results_framework/',
        views.project_results_framework,
        name='project_results_framework'),
    path('v1/bulk-add-periods/<int:project_pk>/',
        views.bulk_add_periods,
        name='bulk_add_periods'),
    path('v1/bulk-remove-periods/<int:project_pk>/',
        views.bulk_remove_periods,
        name='bulk_remove_periods'),
    path('v1/project/<int:project_pk>/indicator/<int:indicator_pk>/previous_cumulative_update',
        views.indicator_previous_cumulative_update,
        name='indicator_previous_cumulative_update'),
    path('v1/project/<int:project_pk>/indicator/<int:indicator_pk>/contribution_count',
...
# Project editor
urlpatterns += (
    path('v1/project/<int:project_pk>/copy_results/<int:source_pk>/',
        views.project_editor_copy_results,
        name='project_editor_copy_results'),
    path('v1/project/<int:project_pk>/import_results/',
        views.project_editor_import_results,
        name='project_editor_import_results'),
    path('v1/project/<int:project_pk>/import_result/<int:parent_result_id>/',
        views.project_editor_import_result,
        name='project_editor_import_result'),
    path('v1/project/<int:project_pk>/import_indicator/<int:parent_indicator_id>/',
        views.project_editor_import_indicator,
        name='project_editor_import_indicator'),
    path('v1/project/<int:project_pk>/reorder_items/',
        views.project_editor_reorder_items,
        name='project_editor_reorder_items'),
    path('v1/project/<int:project_pk>/default_periods/',
        views.project_default_periods,
        name='project_default_periods'),
    path('v1/project/<int:project_pk>/period-labels/',
        views.project_period_labels,
        name='project_period_labels'),
    path('v1/project/<int:project_pk>/indicator_custom_fields/',
        views.project_default_periods,
        name='project_indicator_custom_fields'),
    path('v1/project_update/<int:pk>/upload_photo/',
        views.upload_indicator_update_photo,
        name='upload_indicator_update_photo'),
    path('v1/project/<int:project_pk>/project-roles/',
        views.project_roles,
        name='project_roles'),
    path('v1/project/<int:project_pk>/invite-user/',
        views.project_invite_user,
        name='project_invite_user'),
    path('v1/project/<int:project_pk>/enumerator-assignment-send/',
...
# GeoJSON views
urlpatterns += (
    path('v1/project_location_geojson',
...
# Project overview
urlpatterns += (
    path('v1/project/<int:pk>/results/',
        views.project_results,
        name='project_results'),
    path('v1/project/<int:project_pk>/result/<int:result_pk>/',
        views.project_result_overview,
        name='project_result_overview'),
    path('v1/project/<int:project_pk>/indicator/<int:indicator_pk>/',
        views.project_indicator_overview,
        name='project_indicator_overview'),
    path('v1/project/<int:project_pk>/results_geo/',
...
# Project enumerators
urlpatterns += (
    path('v1/project/<int:project_pk>/enumerators/',
...
# Program
urlpatterns += (
    path('v1/program/<int:program_pk>/add-project/',
        views.add_project_to_program,
        name='add_project_to_program'),
    path('v1/program/<int:program_pk>/countries/',
        views.program_countries,
        name='program_countries'),
    path('v1/program/<int:program_pk>/updates/',
