...
class OrganisationDocumentSerializer(BaseRSRSerializer):
    ...
    categories = OrganisationDocumentCategorySerializer(source='categories', many=True, required=False)
    countries = OrganisationDocumentCountrySerializer(source='countries', many=True, required=False)
