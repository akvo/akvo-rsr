...
urlpatterns = patterns('',
    ...
    # Payment engines
    url(r'^rsr/mollie/report/$', 'akvo.rsr.views.mollie_report',
        name='mollie_report'),
    ...
    url(r'^rsr/project/(?P<project_id>\d+)/donate/$',
        ...
        name='project_donate'),
    url(r'^rsr/donate/paypal/thanks/$', 'akvo.rsr.views.paypal_thanks',
        name='paypal_thanks'),
    url(r'^rsr/donate/ideal/thanks/$', 'akvo.rsr.views.mollie_thanks',
        name='mollie_thanks'),
    url(r'^rsr/donate/500/$', direct_to_template, {'template': 'rsr/donate_500.html'},
        name='donate_500'),
