...
world.AKVO_ADMIN_USER = 'rerochet'
world.AKVO_ADMIN_PASSWORD = 'Iv2tmcae'
...
world.MOLLIE_VAT_PCT = 20  # Dutch VAT changed on Mollie transations
world.PCT_MAX_OVERPAYMENT = 2 # projects may be overfunded by this % of their total budget
