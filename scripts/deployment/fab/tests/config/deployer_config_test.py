...
class DeployerConfigTest(unittest.TestCase):
    ...
    def test_has_expected_rsr_archive_url(self):
        """fab.tests.config.deployer_config_test.DeployerConfigTest  Has expected RSR archive URL"""
    ...
    def test_has_repo_checkout_root(self):
        """fab.tests.config.deployer_config_test.DeployerConfigTest  Has repository checkout root setting"""
    ...
    def test_has_expected_repo_archives_dir(self):
        """fab.tests.config.deployer_config_test.DeployerConfigTest  Has expected repository archives directory"""
    ...
    def test_has_expected_unpacked_rsr_archive_match(self):
        """fab.tests.config.deployer_config_test.DeployerConfigTest  Has expected match for an unpacked RSR archive"""
    ...
    def test_has_expected_rsr_deployment_dir_name(self):
        """fab.tests.config.deployer_config_test.DeployerConfigTest  Has expected RSR deployment directory name"""
    ...
    def test_has_expected_rsr_deployment_root(self):
        """fab.tests.config.deployer_config_test.DeployerConfigTest  Has expected RSR deployment root"""
    ...
    def test_has_expected_akvo_permissions_group_setting(self):
        """fab.tests.config.deployer_config_test.DeployerConfigTest  Has expected Akvo permissions group setting"""

        self.assertEqual("www-edit", self.deployer_config.akvo_permissions_group)

    def test_has_virtualenvs_home_setting(self):
        """fab.tests.config.deployer_config_test.DeployerConfigTest  Has virtualenvs home setting"""
    ...
    def test_has_expected_rsr_env_name(self):
        """fab.tests.config.deployer_config_test.DeployerConfigTest  Has expected RSR virtualenv name"""
    ...
    def test_has_expected_rsr_env_path(self):
        """fab.tests.config.deployer_config_test.DeployerConfigTest  Has expected RSR virtualenv path"""
    ...
    def test_has_expected_pip_install_log_file_path(self):
        """fab.tests.config.deployer_config_test.DeployerConfigTest  Has expected pip install log file path"""
    ...
    def test_has_expected_pip_requirements_home(self):
        """fab.tests.config.deployer_config_test.DeployerConfigTest  Has expected pip requirements home"""
