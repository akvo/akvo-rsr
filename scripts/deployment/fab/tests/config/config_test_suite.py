...
def config_suite():
    config_suite = TestSuiteLoader().create_suite_from_classes([DataRetrieverConfigTest, DeployerConfigTest])

    return TestSuiteLoader().create_suite_from_list([config_suite, linux_config_suite()])
