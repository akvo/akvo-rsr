...
class PermissionsTest(mox.MoxTestBase):
    ...
    def test_can_ensure_user_is_member_of_specified_group(self):
        """fab.tests.helpers.permissions_test.PermissionsTest  Can ensure user is a member of the specified system group"""
    ...
    def test_abort_if_user_is_not_a_member_of_specified_group(self):
        """fab.tests.helpers.permissions_test.PermissionsTest  Abort if the user is not a member of the specified system group"""
    ...
    def test_can_set_akvo_ownership_on_specified_path(self):
        """fab.tests.helpers.permissions_test.PermissionsTest  Can set Akvo permission group ownership on specified path"""
    ...
    def test_can_set_akvo_group_permissions_on_specified_path(self):
        """fab.tests.helpers.permissions_test.PermissionsTest  Can set Akvo group permissions on specified path"""
