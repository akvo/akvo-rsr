...
class FileSystemTest(mox.MoxTestBase):
    ...
    def test_can_compress_directory(self):
        """fab.tests.helpers.filesystem_test  Can compress a specified directory"""
    ...
    def test_can_compress_directory_with_trailing_path_separator(self):
        """fab.tests.helpers.filesystem_test  Can compress a specified directory even with a trailing path separator"""
    ...
    def test_can_delete_an_existing_file(self):
        """fab.tests.helpers.filesystem_test  Can delete an existing file"""
    ...
    def test_can_delete_an_existing_file_with_sudo(self):
        """fab.tests.helpers.filesystem_test  Can delete an existing file with sudo"""
    ...
    def test_do_nothing_on_attempt_to_delete_a_nonexistent_file(self):
        """fab.tests.helpers.filesystem_test  Do nothing on attempt to delete a nonexistent file"""
    ...
    def test_do_nothing_on_attempt_to_delete_a_nonexistent_file_with_sudo(self):
        """fab.tests.helpers.filesystem_test  Do nothing on attempt to delete a nonexistent file with sudo"""
    ...
    def test_can_delete_an_existing_directory(self):
        """fab.tests.helpers.filesystem_test  Can delete an existing directory"""
    ...
    def test_can_delete_an_existing_directory_with_sudo(self):
        """fab.tests.helpers.filesystem_test  Can delete an existing directory with sudo"""
    ...
    def test_do_nothing_on_attempt_to_delete_a_nonexistent_directory(self):
        """fab.tests.helpers.filesystem_test  Do nothing on attempt to delete a nonexistent directory"""
    ...
    def test_do_nothing_on_attempt_to_delete_a_nonexistent_directory_with_sudo(self):
        """fab.tests.helpers.filesystem_test  Do nothing on attempt to delete a nonexistent directory with sudo"""
