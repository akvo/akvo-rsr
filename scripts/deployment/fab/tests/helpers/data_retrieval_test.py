...
class DataRetrievalTest(mox.MoxTestBase):
    ...
    def test_can_fetch_data_from_database(self):
        """fab.tests.helpers.data_retrieval_test  Can fetch data from database"""
        ...
        self.data_retrieval.fetch_data_from_database()


def suite():
    return TestSuiteLoader().load_tests_from(DataRetrievalTest)
