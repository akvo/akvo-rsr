...
def helpers_suite():
    return TestSuiteLoader().create_suite_from_classes([AkvoPermissionsTest, CodebaseTest, DataRetrieverTest, ExecutionFeedbackTest,
                                                        FileSystemTest, HostsTest, InternetTest, PathTest, VirtualEnvTest])
