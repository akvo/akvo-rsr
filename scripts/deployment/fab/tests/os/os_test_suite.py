...
def os_suite():
    return TestSuiteLoader().create_suite_from_list([system_info_suite(), path_info_suite(), symlink_info_suite(),
                                                     os_command_suite(), file_system_suite(), permissions_suite(),
                                                     linux_suite()])
