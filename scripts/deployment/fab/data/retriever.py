...
class RSRDataRetriever(object):
    ...
    def fetch_data_from_database(self):
        ...
        self.rsr_data_dump_path = self.config.time_stamped_rsr_data_dump_path()
    ...
    def _extract_latest_data(self):
        ...
        self.virtualenv.run_within_virtualenv("python %s -d %s dump" % (self.config.db_dump_script_path, self.rsr_data_dump_path))
