...
def convert_rsr_database_for_migrations():
    TaskRunner.create().run_remote_deployment_task(ConvertRSRDatabaseForMigrations)


if __name__ == '__main__':
    convert_rsr_database_for_migrations()
