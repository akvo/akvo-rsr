...
class HomePageMenuNavigationTest(DWSWebTestCase):
    ...
    def test_01_home_page_menu_has_expected_sections(self):
        """web.navigation.HomePageMenuNavigationTest  1. Home page menu has expected sections"""
    ...
    def test_02_focus_areas_link_redirects_to_focus_areas_page(self):
        """web.navigation.HomePageMenuNavigationTest  2. Focus Areas link redirects to Focus Areas page"""

        self.open_starting_page()
        self.navigation_verifier.verify_navigation_to_focus_areas_page()

    def test_03_projects_link_redirects_to_projects_page(self):
        """web.navigation.HomePageMenuNavigationTest  3. Projects link redirects to Projects page"""
    ...
    def test_04_netherlands_link_redirects_to_netherlands_page(self):
        """web.navigation.HomePageMenuNavigationTest  4. Netherlands link redirects to Netherlands page"""
...
def suite():
    return load_tests_from(HomePageMenuNavigationTest)
