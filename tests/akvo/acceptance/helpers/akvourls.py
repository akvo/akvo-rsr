...
# Generate URL functions for each of the Akvo page paths and attach them
# dynamically to this module, e.g. the akvopaths.about_page() function
# will have a corresponding akvourls.about_url() function
